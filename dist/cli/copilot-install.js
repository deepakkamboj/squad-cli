 ...
 * 5. Otherwise → unknown
 */
export function detectCopilotEnvironment(indicators) {
 ...
 */
export function getInstallInstructions(env) {
    switch (env) {
        case 'cli':
            return [
 ...
 */
export async function installFromCopilot(env, projectDir, config) {
    ...
    try {
        ...
        return {
            ...
            environment: env,
            createdFiles: [],
            instructions: [`Installation failed: ${err.message}`],
        };
    }
...
//# sourceMappingURL=copilot-install.js.map