...
const migrations = [
    ...
    },
    {
        ...
        run(squadDir) {
            ...
            const skillNames = storage.listSync(legacySkillsDir).filter(entry => storage.existsSync(path.join(legacySkillsDir, entry, 'SKILL.md')));
            ...
            for (const skillName of skillNames) {
                copyDirRecursive(path.join(legacySkillsDir, skillName), path.join(copilotSkillsDir, skillName), false);
            }
