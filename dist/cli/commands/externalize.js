 ...
 */
export function runExternalize(projectDir, projectKey) {
 ...
 */
export function runInternalize(projectDir) {
    const squadDir = path.join(projectDir, '.squad');
    const configPath = path.join(squadDir, 'config.json');
    if (!storage.existsSync(configPath)) {
...
//# sourceMappingURL=externalize.js.map