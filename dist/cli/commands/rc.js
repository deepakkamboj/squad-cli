...
export async function runRC(cwd, options) {
    ...
    if (process.platform === 'win32') {
        const winPath = path.join('C:', 'ProgramData', 'global-npm', 'node_modules', '@github', 'copilot', 'node_modules', '@github', 'copilot-win32-x64', 'copilot.exe');
        ...
        if (!isDevtunnelAvailable()) {
            ...
            try {
                ...
                try {
                    ...
                    qrcode.default.generate(tunnel.url, { small: true }, (code) => {
                        console.log(code);
                    });
                }
                catch {
