...
const MISSING_MODULE_RE = /\b(?:MODULE_NOT_FOUND|ERR_MODULE_NOT_FOUND)\b|Cannot find module|Cannot find package/i;
...
export async function runStart(cwd, options) {
    ...
    try {
        ...
        console.error(`${YELLOW}\u2717${RESET} ${err.message}`);
    ...
    const copilotExePath = path.join('C:', 'ProgramData', 'global-npm', 'node_modules', '@github', 'copilot', 'node_modules', '@github', 'copilot-win32-x64', 'copilot.exe');
