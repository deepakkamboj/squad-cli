 ...
 */
export function useTypewriter(text, durationMs = 500) {
 ...
 */
export function useFadeIn(active, durationMs = 300) {
    const noColor = isNoColor();
 ...
 */
export function useCompletionFlash(agents, flashMs = 1500) {
    const noColor = isNoColor();
 ...
 */
export function useMessageFade(totalCount, fadeMs = 200) {
    const noColor = isNoColor();
