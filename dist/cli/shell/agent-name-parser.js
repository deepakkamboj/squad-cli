 ...
 */
export function parseAgentFromDescription(description, knownAgentNames) {
    ...
    if (colonName) {
        ...
        if (knownAgentNames.includes(candidate)) {
            const afterColon = description.slice((anyColonMatch.index ?? 0) + anyColonMatch[0].length).replace(/^\s*/, '').slice(0, 60);
...
//# sourceMappingURL=agent-name-parser.js.map